...
export default class IngestCSV extends Component {
    ...
    handleStartIngest = (isSubmitInProgress, numErrors) => {
        if (isSubmitInProgress || numErrors > 0) {
            //prevent submission
            return;
        }
        return this.props
            .createIngestRecord(this.props.csv.form)
    ...
    handleDeleteCustomField = (fieldId, isDefaultField) => {
        if (!isDefaultField) {
            //since `disabled` input still propagating onClick event
    ...
    render() {
        ...
        const startButton = (
            <span
                disabled={
                    this.props.csv.isFileUploading ||
                    this.props.csv.isFileUploaded
                }
                className="button is-info is-outline"
                onClick={() => this.handleResumeFileUpload()}
            >
        ...
        const pauseButton = (
            <span
                ...
                className="button is-info is-outline"
                onClick={() => this.handlePauseFileUpload()}
            >
        ...
        const cancelButton = (
            <span
                disabled={this.props.csv.isFileUploaded}
                className="button is-info is-outline"
                onClick={() => this.handleCancelFileUpload()}
            >
        ...
        const counts = Object.keys(inputs).reduce(
            (counts, key) => {
                const errors = this.props.csv.form.errors;
                const requiredType = inputs[key].requiredType;
                counts[requiredType] = errors[key]
                    ? counts[requiredType] + 1
                    : counts[requiredType];
                return counts;
            },
            { hard: 0, soft: 0 }
        ...
        return (
            <div className="csv-ingest">
                        ...
                        <div className="column">
                            <div className="file-upload">
                                ...
                                {!this.props.csv.form.errors.file &&
                                    this.props.csv.form.file.value && (
                                        <div>
                                ...
                                {this.props.csv.form.errors.file && (
                                    <div>
                                        <span className="file-meta validation-error">
                                            No file selected. Click the button
                            ...
                            <div className="table-reset">
                                <div className="field-mapping">
                                    <table className="table is-fullwidth is-bordered">
                                        ...
                                        <tbody>
                                            {this.props.csv.destinationArr.map(
                                                (dest, index) => (
                                                    <React.Fragment key={index}>
                                                        <tr
                                                            className={`mapping-main-row ${validationClass(
                                                                dest.requiredType,
                                                                this.props.csv
                                                                    .form
                                                                    .errors[
                                                        ...
                                                        >
                                                            ...
                                                            {dest.type ===
                                                                ...
                                                                <td>
                                                                    <div
                                                                        className={`select ${validationClass(
                                                                            dest.requiredType,
                                                                            this
                                                                                .props
                                                                                .csv
                                                        ...
                                                        {this.props.csv.form
                                                            ...
                                                            <tr
                                                                className={`mapping-validation-message-row ${
                                                                    dest.requiredType ===
                                                                    "hard"
                                                                        ? "validation-error"
                                                                        : "validation-warning"
                                ...
                                <a
                                    ...
                                    onClick={() =>
                                        this.handleToggleAddCustomFieldModal(
                                            "open"
                                        )
                                    }
                                >
                            ...
                            <div className="start-ingest">
                                <a
                                    className={`button is-link ${
                                        isSubmitInProgress ? "is-loading" : ""
                                    }`}
                                    onClick={() =>
                                        this.handleStartIngest(
                                            isSubmitInProgress,
                                            counts.hard
                                        )
                                    }
                                    disabled={
                                        (isSubmitInProgress ? true : false) ||
                                        counts.hard > 0
                                    }
                                >
                                    {isSubmitInProgress
                                ...
                                {counts.soft > 0 && (
                                    <span className="start-ingest-warning-count">
                                        Warning Count: {counts.soft}
                                    </span>
                                )}
                                {counts.hard > 0 && (
                                    <span className="start-ingest-error-count">
                                        Error Count: {counts.hard}
                                    </span>
                                )}
                            </div>
                            {this.props.csv.status && (
                                <div className="status">
                                    Status: {this.props.csv.status}
                                </div>
                            )}
                        </div>
                    </div>
                                ...
                                <tr>
                                    <td className="progress-bar">
                                        <progress
                                            ...
                                            value={this.state.progressBarInt}
                                            max="100"
                                        >
                                            {this.state.progressBarInt}%
                                        </progress>
                                    </td>
                ...
                <div
                    className={`modal ${
                        this.props.csv.addCustomFieldModalActive
                            ? "is-active"
                            : ""
                    }`}
                >
                                    ...
                                    <div className="field">
                                        <div className="control">
                                            <input
                                                ...
                                                name="friendlyName"
                                                onChange={e =>
                                                    this.handleCustomFieldFormInputChange(
                                                        e
                                                    )
                                                }
                                            />
                            ...
                            <div className="field is-horizontal">
                                ...
                                <div className="field-body">
                                    <div className="field is-narrow">
                                        ...
                                        <p className="help">
                                            The dynamic suffix applied to the
                                            solr key. E.g. report_metadata_attr
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="field is-horizontal">
                                ...
                                <div className="field-body">
                                    <div className="field is-narrow">
                                        ...
                                        <p className="help">
                                            Whether the field will be a select
                                            dropdown of text input (manual)
                                            field.
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div className="field is-horizontal">
                                ...
                                <div className="field-body">
                                    <div className="field is-narrow">
                                        ...
                                        <p className="help">
                                            Does not filling out the field
                                ...
                                <div className="field-body">
                                    <div className="field">
                                        ...
                                        <p className="help">
                                            ...
                                            when a warning/error is triggered.
                                        </p>
                                    </div>
                                </div>
                            </div>
